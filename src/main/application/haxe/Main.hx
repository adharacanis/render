...
class Main 
{
	...
	public function new() 
	{
		...
		geometry.setVertexAndUV(0, -0.5,  0.5, 0.0, 0.0);
		geometry.setVertexAndUV(1, -0.5, -0.5, 0.5, 0.0);
		geometry.setVertexAndUV(2,  0.5, -0.5, 0.5, 0.5);
		geometry.setVertexAndUV(3,  0.5,  0.5, 0.0, 0.5);
		
		//geometry.setVertex(0, -0.5,  0.5);
